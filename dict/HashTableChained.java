...
public class HashTableChained implements Dictionary {
  ...
  public Entry insert(Object key, Object value) {
    // Replace the following line with your solution.
      try{
        ...
        return new DictEntry("ahh","error");
      }
  }
  ...
  public int countCollision(){
  	...
  	for (int k = 0; k < arraysize; k ++){
  	    if (list[k] != null && list[k].length() > 1){
  		      collision += (list[k].length() - 1);
  		      System.out.println("Bucket[" + k + "] " + (list[k].length() - 1) + " ");
  	    }else if (list[k]!= null && list[k].length() == 1){
  		      System.out.println("Bucket[" + k + "] 0" );
  	    }else{
  	    	System.out.println("Bucket[" + k + "] null" );
  	    }
  	}
  	return collision;
  }
  ...
  public static void main(String[] args){
      ...
      System.out.println(test.insert("Gerald", "cool"));
      System.out.println(test.insert("Yo", "What's up"));
